			...
			this.template = '<div class="dtp hidden" id="' + this.name + '">' +
								'<div class="dtp-content">' +
									...
									'<div class="dtp-buttons">' +
										...
										'<button class="dtp-btn-clear btn hidden">' + this.params.clearText + '</button> &nbsp;' +
										'<button class="dtp-btn-cancel btn">' + this.params.cancelText + '</button> &nbsp;' +
										'<button class="dtp-btn-ok btn">' + this.params.okText + '</button>' +
										'<div class="clearfix"></div>' +
									'</div>' +
								'</div>' +
							'</div>';
